    ...
    <div className="topbar-wrap">
      <header className="topbar">
        ...
        <div className="header-actions">
          ...
          <button type="button" className="mode-toggle" aria-pressed={explorerMode === 'dense'} aria-label={explorerMode === 'simple' ? 'Switch to dense mode' : 'Switch to simple mode'} onClick={() => { const next = explorerMode === 'simple' ? 'dense' : 'simple'; setExplorerMode(next); trackEvent('explorer_mode_changed', { mode: next }) }}><span className="mode-toggle-dot" /><span>{explorerMode === 'simple' ? 'Simple' : 'Dense'}</span></button>
