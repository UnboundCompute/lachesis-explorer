...
export function ConvergenceCanvas({ flows, nodes, sinkId, selectedId, onSelect }: Props) {
  ...
  return <section className="convergence-canvas" aria-label="Converging value flows">
